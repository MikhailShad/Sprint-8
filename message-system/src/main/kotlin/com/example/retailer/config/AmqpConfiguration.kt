...
class AmqpConfiguration {
    companion object {
        ...
        const val RETAILER_NAME: String = "MikhailShad"
    }
    ...
    fun retailerQueueBinding(): Binding {
        return BindingBuilder.bind(retailerQueue())
    ...
    @Bean
    fun rabbitListContainerFactory(connectionFactory: ConnectionFactory): SimpleRabbitListenerContainerFactory {
